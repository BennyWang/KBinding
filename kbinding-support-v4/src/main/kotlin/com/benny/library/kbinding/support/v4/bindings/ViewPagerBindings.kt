...
fun ViewPager.fragmentAdapter(vararg paths: String, mode: OneWay = BindingMode.OneWay, converter: OneWayConverter<FragmentPagerAdapter> = EmptyOneWayConverter()) : PropertyBinding = oneWayPropertyBinding(paths, Action1 { Log.d("FragmentPagerAdapter", "convert2 before is " + it);adapter = it;Log.d("FragmentPagerAdapter", "convert2 after is " + it) }, false, converter)
fun ViewPager.fragmentAdapter(vararg paths: String, mode: OneTime, converter: OneWayConverter<FragmentPagerAdapter> = EmptyOneWayConverter()) : PropertyBinding = oneWayPropertyBinding(paths, Action1 { adapter = it;Log.d("FragmentPagerAdapter", "convert2 is " + it) }, true, converter)